...
for i in range(num_envs):
    mujoco_envs[i].init_set_state.remote(scene='category_tray')
...
positions = ray.get(mujoco_envs[0].get_sampled_position.remote(offset=[0,0,0.02], scene='category_tray', threshold=0.05, 
...
for env_idx, env in remaining_envs:
    env.get_feasible_position.remote(splited_positions[env_idx], scene='category_tray', var_threshold=150, VERBOSE=True, 
                                     quat_bounds = [0.696, 0.72], perturb_tick = 500, noise_scale = 0.0025,
