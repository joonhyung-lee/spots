...
config['num_cpus'] = 48
config['num_gpus'] = 4
config['file_name'] = "20230908" # config['file_name']
...
for i in range(num_envs):
    mujoco_envs[i].init_set_state.remote(scene='office_bookshelf')
...
positions = ray.get(mujoco_envs[0].get_sampled_position.remote(offset=[0,0,0.0], scene='office_bookshelf', threshold=0.05, 
