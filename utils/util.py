...
def get_geom_region_type1(env, obj_name):
    ...
    corners = np.array([
        ...
        [center_x - size_w*0.85, center_y - size_h, center_z + size_d],
        # [center_x - size_w, center_y + size_h, center_z - size_d],
        [center_x - size_w*0.85, center_y + size_h, center_z + size_d],
        # [center_x + size_w, center_y - size_h, center_z - size_d],
        [center_x + size_w*0.85, center_y - size_h, center_z + size_d],
...
def get_geom_region_type4(env, obj_name):
    ...
    corners = np.array([
        # [center_x - size_w, center_y - size_h, center_z - size_d],
        [center_x - size_h, center_y - size_w, center_z + size_d],
        # [center_x - size_w, center_y + size_h, center_z - size_d],
        [center_x - size_h, center_y + size_w, center_z + size_d],
        # [center_x + size, center_y - size_h, center_z - size_d],
        [center_x + size_h, center_y - size_w, center_z + size_d],
        # [center_x + size_w, center_y + size_h, center_z - size_d],
        [center_x + size_h, center_y + size_w, center_z + size_d],
    ])
...
# dish rack small
def get_geom_region_type5(env, obj_name):
    center_x, center_y, center_z, size_w, size_h, size_d = env.model.geom_aabb[env.model.body(obj_name).geomadr][0]
    obj_pos_x, obj_pos_y, obj_pos_z = env.get_p_body(obj_name)
    obj_R = env.get_R_body(obj_name)
    ...
    corners = np.array([
        # [center_x - size_w, center_y - size_h, center_z - size_d],
        [center_x - 10*size_h, center_y - 3*size_w, center_z + 2*size_d],
        # [center_x - size_w, center_y + size_h, center_z - size_d],
        [center_x - 10*size_h, center_y + 3*size_w, center_z + 2*size_d],
        # [center_x + size, center_y - size_h, center_z - size_d],
        [center_x + 10*size_h, center_y - 3*size_w, center_z + 2*size_d],
...
# dish rack black
def get_geom_region_type6(env, obj_name):
    center_x, center_y, center_z, size_w, size_h, size_d = env.model.geom_aabb[env.model.body(obj_name).geomadr][0]
    obj_pos_x, obj_pos_y, obj_pos_z = env.get_p_body(obj_name)
    obj_R = env.get_R_body(obj_name)
    ...
    corners = np.array([
        # [center_x - size_w, center_y - size_h, center_z - size_d],
        [center_x - 1.5*size_w, center_y - size_h, center_z + size_d],
        # [center_x - size_w, center_y + size_h, center_z - size_d],
        [center_x - 1.5*size_w, center_y + size_h, center_z + size_d],
        # [center_x + size_w, center_y - size_h, center_z - size_d],
        [center_x + 1.5*size_w, center_y - size_h, center_z + size_d],
